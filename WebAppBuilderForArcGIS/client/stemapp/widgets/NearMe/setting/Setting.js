...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postMixInProperties: function () {
      ...
      this.nls.searchSetting.enableProximitySearch = this.nls.enableProximitySearch || "Enable proximity search";
      this.nls.searchSetting.enableProximitySearchHintText = this.nls.enableProximitySearchHintText ||
    ...
    **/
    _initTabs: function () {
      var layerSettingTab, routeSettingTab, searchSourceSettingTab, symbologySettingTab, tabs;
      ...
      tabs = [searchSourceSettingTab, layerSettingTab, routeSettingTab, symbologySettingTab];
    ...
    **/
    getConfig: function () {
      var searchSources, maxResultCount, attributeSymbology;
