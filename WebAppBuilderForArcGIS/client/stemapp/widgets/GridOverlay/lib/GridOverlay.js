...
define([
  ...
  return declare(null, {
    ...
    constructor: function (args) {
      ...
      this._isIE = window.navigator.userAgent.indexOf("MSIE") > 0 ? true : false;
      this._isIE11 = window.navigator.userAgent.indexOf("Trident") > 0 ? true : false;
    },
    ...
    setLineWidth: function (index, width) {
      if (typeof index !== "number" || typeof width !== "number" ||
    ...
    setInterval: function () {
      this.currentInterval = gridUtils.getInterval(this.getMinIntervalSpacing(),
        this.map, this.getLevelOfDetail());
    },
    getMap: function () {
      return this.map;
    },
    ...
    _drawGrid: function () {
      ...
      this._drawing = setTimeout(lang.hitch(this, function () {
        ...
        // these are added as properties to 'this' in order to
        // make it easier to pass them by reference
        this._lineGraphics = [];
        this._lineGraphics0 = [];
        this._lineGraphics1 = [];
        this._lineGraphics2 = [];
        ...
        array.forEach([this._lineGraphics5,
          this._lineGraphics4,
          this._lineGraphics3,
          this._lineGraphics2,
          this._lineGraphics1,
          this._lineGraphics0], function (arr) {
