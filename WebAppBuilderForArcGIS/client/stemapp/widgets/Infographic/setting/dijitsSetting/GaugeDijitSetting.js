...
define([
  ...
  function(declare, _WidgetsInTemplateMixin, lang, html, Color, on, BaseDijitSetting,
    ...
    TogglePocket, TabContainer3, ColorPickerPopup, jimuUtils) {
    var clazz = declare([BaseDijitSetting, _WidgetsInTemplateMixin], {
      ...
      getConfig: function() {
        ...
        if (!this.dataRangeMin.isValid() || min === '' ||
          !this.dataRangeMax.isValid() || max === '') {
          return false;
        }
