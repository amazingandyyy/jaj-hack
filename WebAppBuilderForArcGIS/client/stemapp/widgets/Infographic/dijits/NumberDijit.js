...
define([
...
], function(declare, lang, BaseDijit, domStyle, html, jimuUtils, utils, styleUtils, LayerInfos, DataSourceManager) {
  var clazz = declare([BaseDijit], {
    ...
    _updateUI: function(config, value) {
      ...
      //init value
      this.valueContent.innerHTML = value === null ? this.nls.noData : value;
