...
define({
  root: ({
    ...
    analysisTab: {
      ...
      areaUnitsLabel: "Show areas/lengths in", // shown as main label in config UI for area units dropdown section.
      ...
      searchToleranceLabelText: "Search tolerance (feet)", // Shown as label in config UI for search tolerance
    ...
    downloadTab: {
      ...
      syncEnableOptionNote: "Note: Sync enabled feature services are required for the File Geodatabase option.", // Shown as the special note in the hint text for sync enable download option
    ...
    errorMsg: {
      ...
      atLeastOneCheckboxCheckedErrorMsg: "Invalid configuration", // Shown as error message if no checkbox field checked in AOI Tools section.
