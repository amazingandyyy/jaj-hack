...
define({
  "units": {
    "standardUnit": "Standardühik",
    "metricUnit": "Meetermõõdustiku ühik"
  },
  "analysisTab": {
    ...
    "areaUnitsLabel": "Näita pindalasid/pikkusi järgmiselt",
    ...
    "searchToleranceLabelText": "Otsingu tolerants (jalgades)",
  ...
  "downloadTab": {
    ...
    "syncEnableOptionNote": "Märkus: suvandid Faili geoandmebaas nõuab lubatud sünkroonimisega objektiteenuseid.",
  ...
  "errorMsg": {
    ...
    "atLeastOneCheckboxCheckedErrorMsg": "Vigane konfiguratsioon",
