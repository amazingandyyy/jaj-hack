...
define({
  "units": {
    "standardUnit": "Стандартные единицы",
    "metricUnit": "Метрические единицы"
  },
  "analysisTab": {
    ...
    "areaUnitsLabel": "Показать площади/длины в",
    ...
    "searchToleranceLabelText": "Допуск поиска (футы)",
  ...
  "errorMsg": {
    ...
    "atLeastOneCheckboxCheckedErrorMsg": "Некорректная настройка",
